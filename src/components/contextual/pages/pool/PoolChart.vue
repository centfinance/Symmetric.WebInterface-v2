...
<template>
  ...
  <div class="chart" v-else-if="snapshotValues.length >= MIN_CHART_VALUES">
    <div
      class="flex flex-col justify-between px-4 mb-6 sm:px-0 xs:flex-row xs:flex-wrap dark:border-gray-900"
    >
      <div class="flex mb-4">
      ...
      <div
        class="flex flex-col items-start text-2xl font-bold xs:items-end tabular-nums"
      >
