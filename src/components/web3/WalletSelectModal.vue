<template>
  ...
  >
    ...
    >
      <h6>New to Defi?</h6>
      <p class="text-sm">
        Symmetric is a DeFi app on Kava, Gnosis (xDai) & Celo. To invest and
        trade here, you'll first need to set up a compatible wallet.
...
export default defineComponent({
  ...
  setup() {
    return {
      wallets: SupportedWallets.filter(
        id => id !== 'gnosis' && id !== 'walletlink' && id !== 'portis'
      ),
      EXTERNAL_LINKS
    };
  }
